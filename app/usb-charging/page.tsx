...
import { USB_CHARGING_PRICE } from "@/data/algeria-data";

// Product images with models - USB CHARGING PRODUCTS
const PRODUCT_IMAGES: ProductImage[] = [
  { url: "/usb-charging-1.jpg", model: "Modèle USB Charging 1" },
  { url: "/usb-charging-2.jpg", model: "Modèle USB Charging 2" },
  { url: "/usb-charging-3.jpg", model: "Modèle USB Charging 3" },
  { url: "/usb-charging-4.jpg", model: "Modèle USB Charging 4" },
  { url: "/usb-charging-5.jpg", model: "Modèle USB Charging 5" },
];

export default function UsbChargingPage() {
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto">
          ...
          <div id="order" className="lg:pt-0">
            <OrderForm 
              ...
              productPrice={USB_CHARGING_PRICE}
            />
          </div>
        </div>
